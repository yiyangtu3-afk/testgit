...
和好友申请通知切片也已完成。下一项继续评论通知，不要重做已完成的聊天、
动态、内容审核和活动报名链路。
...
静态前端版本为 `20260715-friend-notifications-v1`，本地地址为：
...
阶段二和阶段三点赞、好友申请通知切片已经完成。下一项为动态评论接入现有
社交通知模块。继续保持 bearer token 身份边界、真实 API 错误不回退 Mock、
