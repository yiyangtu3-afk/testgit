...
当前前端版本为 `20260715-notification-actions-v1`，本地验证地址为
`http://127.0.0.1:5179/?v=20260715-notification-actions-v1`。当前基线保留
...
下一项继续阶段三，为好友申请类通知补齐可追溯的操作入口：当前收件人应能从
好友申请通知进入自己的待处理申请，并复用已有同意或拒绝操作。每个可演示小
阶段都更新 README 和本路线的完成状态。
