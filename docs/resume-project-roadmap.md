...
当前前端版本为 `20260712-activity-notifications-v1`，本地验证地址为
`http://127.0.0.1:5179/?v=20260712-activity-notifications-v1`。当前基线保留
...
下一项实现组织者报名名单、签到与导出，并让管理员指标读取真实的活动报名与
签到数据。每个可演示小阶段都更新 README 和本路线的完成状态。
