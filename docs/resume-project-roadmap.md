...
当前前端版本为 `20260712-activity-operations-v1`，本地验证地址为
`http://127.0.0.1:5179/?v=20260712-activity-operations-v1`。当前基线保留
...
下一项进入阶段三，优先把好友申请、动态评论和点赞结果接入持久化通知，并把
点赞改为按用户记录的可取消操作。每个可演示小阶段都更新 README 和本路线的
完成状态。
