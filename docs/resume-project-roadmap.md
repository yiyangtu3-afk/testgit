...
当前前端版本为 `20260715-friend-request-actions-v1`，本地验证地址为
`http://127.0.0.1:5179/?v=20260715-friend-request-actions-v1`。当前基线保留
...
好友申请通知已支持由当前收件人安全进入自己的待处理申请，并复用已有同意或
拒绝操作。下一项继续阶段三，为动态、评论和活动补充真实统计和筛选。每个可
