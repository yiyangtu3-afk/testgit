...
import { loadAdminData, loadFeed, loadPersonalPosts } from "../loaders.js?v=20260715-friend-request-actions-v1";
import { renderPersonalPostManager } from "./renderers.js?v=20260715-friend-request-actions-v1";
