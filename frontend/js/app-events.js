...
import { bindActivityEvents } from "./activities/events.js?v=20260712-activity-notifications-v1";
import { bindAdminAuditEvents } from "./admin/audit-events.js?v=20260712-activity-notifications-v1";
import { bindPersonalPostEvents } from "./posts/personal-post-events.js?v=20260712-activity-notifications-v1";
import { bindActivityNotificationEvents } from "./notifications/events.js?v=20260712-activity-notifications-v1";
import { state, reportRanges } from "./state.js";
import { $ } from "./utils/dom.js?v=20260712-activity-notifications-v1";
import { isAdminUser } from "./utils/auth.js?v=20260712-activity-notifications-v1";
import { filesToAttachments, reportToCsv } from "./utils/format.js?v=20260712-activity-notifications-v1";
import { loadActivities, loadActivityNotifications, loadAdminData, loadComments, loadFeed, loadFriendRequests, loadFriends, loadMessages, loadPersonalPosts, loadUsers } from "./loaders.js?v=20260712-activity-notifications-v1";
import { enterDemoWorkspace, loginWithCode, sendLoginCode } from "./auth/session.js?v=20260712-activity-notifications-v1";
import { logout, switchAccount } from "./auth/workspace.js?v=20260712-activity-notifications-v1";
import { currentPeer, renderAttachmentTray, renderExportPanel, renderFeed, renderIdentity, renderMessages, switchTab } from "./ui/renderers.js?v=20260712-activity-notifications-v1";
...
export function bindAppEvents() {
  bindActivityEvents();
  bindActivityNotificationEvents();
