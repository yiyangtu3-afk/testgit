...
export const api = {
  ...
  socialNotificationFriendRequestTarget(notificationId) {
    return withApi(
      () => request(`/social-notifications/${notificationId}/friend-request-target`),
      () => mockApi.socialNotificationFriendRequestTarget(notificationId)
    );
  },
  metrics() {
