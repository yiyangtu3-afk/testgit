...
const filter = ref("all"); const authorFilter = ref(""); const statusFilter = ref("all"); const activityReasons = ref({}); const reportRange = ref("today");
