...
export function createAdminStore({ api, getUser = () => null, setMode = () => {} } = {}) {
  return () => {
    ...
    return { metrics, activities, moderation, audits, notice, loading, report, selectedModeration, selectedAudits, moderationAssistance, assistanceLoadingId, isAdmin, load, toggle, reviewActivity, resolveModeration, loadModerationAssistance, deleteModeration, deleteAudits, generateReport };
  };
}
